...
<body>
<div class="container">
<h1><?= htmlspecialchars($_SESSION['username']); ?> (<?= htmlspecialchars($pilihanSekarang); ?>)</h1>
    <hr>
    <h5>Total Data CS (<?= htmlspecialchars($pilihanSekarang); ?>)</h5>
...
<div class="container">
<nav>
<a href="tambah.php?tabel=<?= urlencode($tabelDipilih); ?>"><button>Tambah Data</button></a>
   <a href="cari.php"><button class="">Cari Data</button></a>
 <a href="rekap.php?tabel=<?= urlencode($tabelDipilih); ?>"><button>Laporan</button></a>
    <?php
// Pastikan username tersedia di sesi
if (!isset($_SESSION['username'])) {
    echo "Session tidak valid. Silakan login kembali.";
